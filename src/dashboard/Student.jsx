...
const Student = () => {
  ...
  return (
    ...
    <div className="AMS-1">
      <SideNav xyz={'student'}/>
    <div className="div-x">
      <div className="text-wrapper-yoyo" style={{display:'flex',flexDirection:'row',justifyContent:'space-between'}}>Student
          ...
          <Column
            ...
            render={(text, record) => (
              <Space size="middle" className="middle">
                ...
                {/* <Column title="blocked" dataIndex="blocked" key="blocked" render={(val) => (
                    (val==true)? "Unblock" : "Block"
                  )}/> */}
                <div>
                  <FontAwesomeIcon
